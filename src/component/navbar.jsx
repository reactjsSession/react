...
export function Navbar(){ 
 ...
 useEffect(()=>{
  ...
  window.addEventListener('click', evenHandler)  

  return () => {
    window.removeEventListener('click', evenHandler)  
    ...
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4 menu_link">
             <NavLink to="/main" className="rounded-md px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</NavLink>
             <NavLink to="/main/product" className="rounded-md   px-3 py-2 text-sm font-medium text-white" aria-current="page">Product</NavLink>
             <NavLink to="/main/contact" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</NavLink>
      ...
      <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <button type="button" className="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden">
         ...
         <div ref={menuref} id='submenu_container' className="relative ml-3">
          <div>
